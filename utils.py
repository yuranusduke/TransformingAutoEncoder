...
def show_weights(weights, dataset : str):
    ...
    plt.axis('off')
    plt.savefig(f'./results/weights_of_generation_{dataset}.png')
    plt.close()

def generate_animnated(dataset = 'mnist'):
    """
    ...
    files = list(filter(lambda x : x.count(dataset), files))
...
if __name__ == '__main__':
    generate_animnated(dataset = 'fashion_mnist')